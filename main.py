...
prompt = PromptTemplate(
    template="""You are a technical assistant specialized in the Verra VM0042 Improved Agricultural Land Management methodology.

Answer the user's question using ONLY the provided VM0042 document context.

RULES:
1. Use ONLY the provided context.
2. Do not use outside knowledge.
3. Do not make assumptions.
4. Do not invent VM0042 requirements, definitions, equations, values, eligibility criteria, or project activities.
...
9. If documents contain conflicting information, clearly mention the conflict.
10. Keep the answer concise and factual.
11. If source or page information is available, mention it.
...
question = st.text_input(
    ...
    placeholder="Example: What are the eligible project activities under VM0042?"
)
...
with st.sidebar:
    ...
    st.write("**LLM:** OpenRouter Free Tier")
